 ...
 * @subpackage TFA_update_attached_file/public
 */
 ...
 */
class TFA_update_attached_file_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $TFA_update_attached_file       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->TFA_update_attached_file, plugin_dir_url( __FILE__ ) . 'css/TFA_update_attached_file-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->TFA_update_attached_file, plugin_dir_url( __FILE__ ) . 'js/TFA_update_attached_file-public.js', array( 'jquery' ), $this->version, false );
